...
export function getWorkspaceExperience(params: {
  ...
  return {
    ...
    shellBadgeLabel: "Modo hibrido",
    shellTitle: `Operacion de ${companyName}`,
    shellDescription: "Acceso a backoffice global y a la operacion tenant dentro del mismo shell.",
